...
<div class="container px-4 px-lg-5">
  <div class="row gx-4 gx-lg-5 justify-content-center">
    <div class="row">
      <div class="col-md-12">
        <form method="post" action="{{ route('create-blogs') }}">
          @csrf
          <div class="row g-3">
            <div class="col-md-12">
              <label for="your-title" class="form-label">Title</label>
              <input type="text" class="form-control" id="your-title" name="title" value="{{ old('title') }}" required>
            </div>
            <div class="col-12">
              <label for="your-content" class="form-label">Content</label>
              <textarea class="form-control" id="your-content" name="content" rows="5" required>{{ old('content') }}</textarea>
            </div>
            <div class="col-12">
              <div class="row">
                <div class="col-md-6">
